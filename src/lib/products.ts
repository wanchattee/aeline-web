...
const FALLBACK_PRODUCTS: Product[] = [
  ...
  {
    id: "b-g-001",
    name: "Gold Cable Bracelet",
    category: "Bracelets",
    price: 1690,
    imageUrl: "/images/products/bracelet-gold-cable.png",
    description: "Chunky oval cable links in warm 18k gold-filled brass. A timeless silhouette designed to be worn solo or layered. Adjustable lobster clasp.",
    slug: "bracelet-gold-cable",
    inStock: true,
    featured: true,
    collectionName: "Essentials",
    material: "18k Gold-filled",
  ...
  {
    id: "b-g-002",
    name: "Gold Paperclip Bracelet",
    category: "Bracelets",
    price: 1590,
    imageUrl: "/images/products/bracelet-gold-paperclip.png",
    description: "Elongated paperclip links joined by delicate knot connectors. Modern, architectural, and effortlessly stackable.",
    slug: "bracelet-gold-paperclip",
    inStock: true,
    featured: true,
    collectionName: "Essentials",
    material: "18k Gold-filled",
  ...
  {
    id: "b-s-001",
    name: "Silver Ribbed Bangle",
    category: "Bracelets",
    price: 890,
    imageUrl: "/images/products/bracelet-silver-ribbed.png",
    description: "A flexible ribbed bangle in polished sterling silver. Slips on smoothly, sits sculpturally on the wrist. Quiet luxury at its purest.",
    slug: "bracelet-silver-ribbed",
    inStock: true,
    featured: false,
    collectionName: "Essentials",
    material: "Sterling Silver",
  },
  {
    ...
    category: "Bracelets",
    price: 790,
    imageUrl: "/images/products/bracelet-silver-paperclip.png",
    description: "Our signature paperclip chain in sterling silver. The architectural cousin of the gold version — clean, sharp, and easy to layer.",
    slug: "bracelet-silver-paperclip",
    inStock: true,
    featured: false,
    collectionName: "Essentials",
    material: "Sterling Silver",
  ...
  {
    id: "r-g-001",
    name: "Initial Charm Ring",
    category: "Rings",
    price: 2290,
    imageUrl: "/images/products/ring-gold-initial.png",
    description: "A pavé band in 18k gold-filled brass with a hanging initial charm. Choose your letter via LINE — A through Z available. The personal heirloom, reimagined.",
    slug: "ring-gold-initial",
    inStock: true,
    featured: true,
    collectionName: "The Eden Collection",
    material: "18k Gold-filled + Cubic Zirconia",
  },
